...
class TestC2902(BaseTest):
    """
    User has the ability to see updated alias on group participants screen
    """
    ALIAS = magic.get_word

    def test_c2902(self):
        log.info("Check updated alias displayed on participants screen")
        ...
        log.info("Verify updated alias displayed on group participants screen")
