...
class TestC21(BaseTest):
    """
    User has no the ability to edit own Username with max limit chars
    """
    NEW_USERNAME = magic.get_string(33)
    ACTUAL_USERNAME = config.UKRAINE_USERNAME

    def test_c21(self):
        log.info("Edit Username with max char limit")
        ...
        Verify.true(profile.error_verify(error_enums.MAX_USERNAME), "The username updated")
